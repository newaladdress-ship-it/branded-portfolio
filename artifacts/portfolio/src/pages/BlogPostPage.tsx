...
export default function BlogPostPage() {
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://www.imrandigitals.com/logo.png"
      }
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://www.imrandigitals.com/blog/${post.slug}`
    }
  };
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: post.title, item: `https://www.imrandigitals.com/blog/${post.slug}` },
    ],
  };
